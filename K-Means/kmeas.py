...
if __name__ == "__main__":
    ...
    plt.subplot(425)
    plt.title(u'heteroscedasticity')
    ...
    plt.subplot(426)
    plt.title(u'KMeans:heteroscedasticity')
    ...
    plt.subplot(428)
    plt.title(u'imbalanced group KMeans clustering')
